...
class Migration{
    ...
    /**
     * TEMPORARY DOCS
     * Method for creating new table (it requires table name)
     */
    public function create($table_name){
        $this->table = "CREATE TABLE " . $table_name . " ";
    ...
    public function save(){
        ...
        "echo \$database->query(\"" . $this->table . $prefix . $this->fields . $this->add_column_after . $sufix ."\"" . "); \n" .
        "?> \n";
